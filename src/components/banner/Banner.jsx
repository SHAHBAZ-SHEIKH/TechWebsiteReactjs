            ...
            <div className="carousel-inner">
                <div className="courserContent">
                    <div className="carousel-item active">
                        <img src="../../public/slider1.jpg" className="d-block w-100" alt="..." />
                    </div>


                    <div className="carousel-item">
                        <img src="../../public/slider2.jpg" className="d-block w-100" alt="..." />
                    </div>
                    <div className="carousel-item">
                        <img src="../../public/slider3.jpg" className="d-block w-100" alt="..." />
                    </div>
